package project.hp.hp001_d006.vo;
...
public class Hp001_d006VO {
	...
	public Hp001_d006VO() {
		System.out.println("자주하는질문VO 호출");
	}
	...
	public String toString() {
		return "Hp001_d006VO [article_no=" + article_no + ", board_cd=" + board_cd + ", writer_id=" + writer_id
				...
				+ is_notice + ", farm_no=" + farm_no + ", email=" + email + ", phone=" + phone + "]";
	}
