package project.hp.hp001_d004.vo;
...
public class Hp001_d004VO {
	...
	public Hp001_d004VO() {
		System.out.println("Hp001_001VO 생성자 호출");
	}
	...
	public String toString() {
		return "Hp001_d002VO [article_no=" + article_no + ", board_cd=" + board_cd + ", writer_id=" + writer_id
				+ ", board_gr_cd=" + board_gr_cd + ", article_nm=" + article_nm + ", article_content=" + article_content
				+ ", reg_date=" + reg_date + ", chg_date=" + chg_date + ", read_cnt=" + read_cnt + ", is_notice="
				+ is_notice + ", farm_no=" + farm_no + ", email=" + email + ", order_number=" + order_number
