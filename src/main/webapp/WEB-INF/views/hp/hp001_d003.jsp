...
<body>
			...
			<ul class="pagination">
				<c:if test="${pagination3.prev}">
					<li class="page-item"><a class="page-link" href="#"
						onClick="fn_prev('${pagination3.page}', '${pagination3.range}', '${pagination3.rangeSize}')">Previous</a></li>
				</c:if>
				...
				<c:if test="${pagination3.next}">
					<li class="page-item"><a class="page-link" href="#"
						onClick="fn_next('${pagination3.range}','${pagination3.range}', '${pagination3.rangeSize}')">Next</a></li>
				</c:if>
			</ul>
	...
	$(document).on('click','#btnWriteForm', function(e){
		...
		location.href = "${pageContext.request.contextPath}/hp/hp001_d003Form";
	});
	
	function fn_contentView(article_no) {
		var url = "${pageContext.request.contextPath}/hp/getBoardContent3";
		...
		function fn_prev(page, range, rangeSize) {
			...
			var url = "${pageContext.request.contextPath}/hp/hp001_d003";
			url = url + "?page=" + page;
			url = url + "&range=" + range;
