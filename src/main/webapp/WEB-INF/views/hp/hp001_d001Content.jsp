...
<c:url var="saveReplyURL" value="/hp/saveReply"></c:url>
<c:url var="updateReplyURL" value="/hp/updateReply"></c:url>
<c:url var="deleteReplyURL" value="/hp/deleteReply"></c:url>
...
<article>
		<div class="container" role="main" align="left">
			...
			<div class="bg-white rounded shadow-sm">
				...
				<div class="board_article_nm">
					<c:out value="${hp001_d001Content.article_nm}" />
				</div>
				
				<div class="board_info_box">
					<span class="board_author"><c:out value="${hp001_d001Content.writer_id}" />,</span>
					<span class="board_date"><c:out value="${hp001_d001Content.reg_date}" /></span>
					
					
					
				</div>
				<div class="board_article_content">${hp001_d001Content.article_content}</div>
			   </div>
			...
			<!-- Reply Form {s} --> 
 			<div class="my-3 p-3 bg-white rounded shadow-sm" style="padding-top: 10px"> 
 				<form:form name="form" id="form" role="form" modelAttribute="reply1VO" method="post"> 
	...
	$(document).on('click','#btnDelete', function(){
		var url = "${pageContext.request.contextPath}/hp/deleteBoard1";
		url = url + "?article_no=" + ${hp001_d001Content.article_no};
		location.href = url;
	});
	// 수정 버튼 클릭 이벤트  
	$(document).on('click', '#btnUpdate', function(){
		var url = "${pageContext.request.contextPath}/hp/editForm1";
		url = url + "?article_no="+${hp001_d001Content.article_no};
		url = url + "&mode=edit";
		location.href = url;
	});
	...
	function showReplyList(){
		...
		var paramData = {"bid" : "${hp001_d001Content.bid}"};
